...
#define LCD_I2C_FREQ_HZ   50000
#define LCD_I2C_SDA       SSD1306_SDA
#define LCD_I2C_SCL       SSD1306_SCL

// HW-061 / common PCF8574 backpack mapping used by LiquidCrystal_I2C.
#define LCD_PIN_RS_BIT    0
#define LCD_PIN_RW_BIT    1
#define LCD_PIN_EN_BIT    2
#define LCD_PIN_BL_BIT    3
...
#define VALIDATE_UART_PORT_NUM      UART_NUM_2
